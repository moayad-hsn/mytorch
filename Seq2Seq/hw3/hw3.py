...
class CharacterPredictor(object):
    ...
    def __init__(self, input_dim, hidden_dim, num_classes):
        ...
        self.rnn = GRUCell(self.input_dim, self.hidden_dim) # TODO
        self.projection = Linear(self.hidden_dim, self.num_classes) # TODO
        self.projection.W = np.random.rand(self.num_classes, self.hidden_dim)
